...
/*   Updated: 2025/09/03 19:27:13 by npugach          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
/* --- External Libraries (MUST BE FIRST FOR macOS) --- */
# include <errno.h>
# include <fcntl.h>
# include <stdio.h>
# include <stdlib.h>
...
/* parser_helpers.c */
t_cmd				*handle_and_token(t_token **tokens, t_shell *shell,
						t_cmd *cmd);
t_cmd				*handle_or_token(t_token **tokens, t_shell *shell,
						t_cmd *cmd);
...
void				add_token_to_list(t_list **list, char *token);
